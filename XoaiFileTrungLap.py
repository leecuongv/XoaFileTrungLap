...
class Duplython:
    ...
    def welcome(self)->None:
        ...
        print("┌──────────────────────────────────────────────┐")
        print("│ ──────────────── Lee Cường ───────────────── │")
        print("│ ─────── Phần mềm xoá file trùng lặp ──────── │")
        time.sleep(3)
        print('│Cleaning .....................................│')
        print("├──────────────────────────────────────────────┤")
        ...
        for path in all_dirs:
            ...
            for file in All_Files:
                ...
                if not filehash in self.File_hashes:
                    ...
                    print('│{:<34} ... cleaned│'.format(filename))
                    print("├──────────────────────────────────────────────┤")
    ...
    def cleaning_summary(self)->None:
        ...
        print('│File cleaned: {:<31} │'.format(self.count_cleaned))
        print('│Total Space saved: {:<24} MB│'.format(mb_saved))
        print("└──────────────────────────────────────────────┘")
